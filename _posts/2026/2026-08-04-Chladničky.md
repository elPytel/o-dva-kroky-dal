---
layout: post
title:  "Chladničky, zajímavost pro dnešní den"
author: "Jarda"
description: Principy a historie chladniček
categories: 
    - nzf
tags: 
    - ledničky
...
- [Technologický přehled ledniček](#technologický-přehled-ledniček)
  - [Kompresorové chladničky](#kompresorové-chladničky)
    - [Proč tato technologie zcela ovládla trh](#proč-tato-technologie-zcela-ovládla-trh)
  - [Termoelektrické chlazení (Peltierův článek)](#termoelektrické-chlazení-peltierův-článek)
  - [Odpařovací chlazení (Evaporativní)](#odpařovací-chlazení-evaporativní)
  - [Absorpční chladničky](#absorpční-chladničky)
    - [Jak funguje bezkompresorová (absorpční) lednice](#jak-funguje-bezkompresorová-absorpční-lednice)
    - [Historický kontext a 50. léta](#historický-kontext-a-50-léta)
    - [Proč je nahradily kompresory?](#proč-je-nahradily-kompresory)
  - [Zdroje:](#zdroje)

## Kompresorové chladničky

![Kompresorová]({{ site.baseurl }}/assets/nzf/kompresorova.png)
...
2. Kondenzátor (odevzdání tepla okolí)
...
3. Expanzní ventil / Kapilára (snížení tlaku)
...
4. Výparník (chlazení vnitřního prostoru)
...
![Peltier]({{ site.baseurl }}/assets/nzf/peltier.png)

![peltier-TEG]({{ site.baseurl }}/assets/nzf/peltier-TEG.jpeg)
...
![Absorpční]({{ site.baseurl }}/assets/nzf/absorpční.gif)
...
![Absorpční_chladnička]({{ site.baseurl }}/assets/nzf/plynova-chladnicka-meva-LE22001-XC-60A-tricestna.webp)
...
![Absorpční_chladnička]({{ site.baseurl }}/assets/nzf/Absorpční_chladnička.jpg)
...
- [wiki: Absorpční lednička](https://cs.wikipedia.org/wiki/Absorpční_lednička)
- [karavanista: Typy lednicek v obytném autě – jak vybrat tu pravou?](https://www.karavanista.cz/blog-2/typy-lednicek-v-obytnem-aute--jak-vybrat-tu-pravou/)